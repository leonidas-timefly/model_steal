...
data0, testdata0 = loadData("retrain/George_W_Bush/")
print(len(data0), len(testdata0))
print("***************************")
data1, testdata1 = loadData("retrain/Colin_Powell/")
data2, testdata2 = loadData("retrain/Tony_Blair/")
data3, testdata3 = loadData("retrain/Donald_Rumsfeld/")
data4, testdata4 = loadData("retrain/Gerhard_Schroeder/")
data5, testdata5 = loadData("retrain/Ariel_Sharon/")
data6, testdata6 = loadData("retrain/Hugo_Chavez/")
data7, testdata7 = loadData("retrain/Jean_Chretien/")
data8, testdata8 = loadData("retrain/John_Ashcroft/")
data9, testdata9 = loadData("retrain/Junichiro_Koizumi/")
data10, testdata10 = loadData("retrain/Serena_Williams/")
data11, testdata11 = loadData("retrain/Jacques_Chirac/")
data12, testdata12 = loadData("retrain/Vladimir_Putin/")
data13, testdata13 = loadData("retrain/Luiz_Inacio_Lula_da_Silva/")
data14, testdata14 = loadData("retrain/Gloria_Macapagal_Arroyo/")
data15, testdata15 = loadData("retrain/Jennifer_Capriati/")
data16, testdata16 = loadData("retrain/Arnold_Schwarzenegger/")
data17, testdata17 = loadData("retrain/Lleyton_Hewitt/")
data18, testdata18 = loadData("retrain/Laura_Bush/")
data19, testdata19 = loadData("retrain/Alejandro_Toledo/")
