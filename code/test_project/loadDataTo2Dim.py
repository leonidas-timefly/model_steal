...
from code.test_project import utils
import os, pdb
import numpy as np
...
data0, testdata0 = loadData("retrain2/George_W_Bush/")
print(len(data0), len(testdata0))
print("***************************")
data1, testdata1 = loadData("retrain2/Colin_Powell/")
data2, testdata2 = loadData("retrain2/Tony_Blair/")
data3, testdata3 = loadData("retrain2/Donald_Rumsfeld/")
data4, testdata4 = loadData("retrain2/Gerhard_Schroeder/")
data5, testdata5 = loadData("retrain2/Ariel_Sharon/")
data6, testdata6 = loadData("retrain2/Hugo_Chavez/")
data7, testdata7 = loadData("retrain2/Jean_Chretien/")
data8, testdata8 = loadData("retrain2/John_Ashcroft/")
data9, testdata9 = loadData("retrain2/Junichiro_Koizumi/")
data10, testdata10 = loadData("retrain2/Serena_Williams/")
data11, testdata11 = loadData("retrain2/Jacques_Chirac/")
data12, testdata12 = loadData("retrain2/Vladimir_Putin/")
data13, testdata13 = loadData("retrain2/Luiz_Inacio_Lula_da_Silva/")
data14, testdata14 = loadData("retrain2/Gloria_Macapagal_Arroyo/")
data15, testdata15 = loadData("retrain2/Jennifer_Capriati/")
data16, testdata16 = loadData("retrain2/Arnold_Schwarzenegger/")
data17, testdata17 = loadData("retrain2/Lleyton_Hewitt/")
data18, testdata18 = loadData("retrain2/Laura_Bush/")
data19, testdata19 = loadData("retrain2/Alejandro_Toledo/")
